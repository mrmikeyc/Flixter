...
<img src="https://github.com/mrmikeyc/Flixter/blob/master/Flix_Walkthrough_Pt2.gif" width=250><br>

### Notes

- Getting the Google Play services up and running.  It would frequently throw connection issues with starting the YouTube application until I changed to a different Android OS (11 down to 8).
